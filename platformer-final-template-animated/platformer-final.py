...
# Images
idle = load_image('assets/images/characters/p2_front.png')
walk = [load_image('assets/images/characters/p2_walk/PNG/p2_walk01.png'),
        load_image('assets/images/characters/p2_walk/PNG/p2_walk02.png'),
        load_image('assets/images/characters/p2_walk/PNG/p2_walk03.png')]
jump = load_image('assets/images/characters/p2_jump.png')
hurt = load_image('assets/images/characters/p2_hurt.png')
...
tile_images = { "Sand": load_image('assets/images/tiles/sand.png'),
                "Grass": load_image('assets/images/tiles/grass.png'),
                "Platform": load_image('assets/images/tiles/platformBrown.png'),
                "PlatformBlue": load_image('assets/images/tiles/platformBlue.png'),
                "Cactus": load_image('assets/images/items/cactus.png'),
                "Mushroom": load_image('assets/images/items/mushroomRed.png'),
                "GrassPlant": load_image('assets/images/items/grassPlant.png'),
                "FlagTop": load_image('assets/images/tiles/flag.png'),
                "FlagPole": load_image('assets/images/tiles/flagpole.png'),
...
class Game():
    ...
    def show_title_screen(self):
        text = font_xxl.render(TITLE, 1, BLACK)
        rect = text.get_rect()
    ...
    def show_stats(self):
        ...
        text = font_sm.render(level_str, 1, BLACK)
        rect = text.get_rect()
        rect.left = 24
        rect.top = 24
        screen.blit(text, rect)
        ...
        text = font_sm.render(score_str, 1, BLACK)
        rect = text.get_rect()
        rect.right = SCREEN_WIDTH - 24
        rect.top = 24
        screen.blit(text, rect)
        
        score_str = "Hearts: " + str(self.hero.hearts)
